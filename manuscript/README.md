This directory contains the manuscript source files for the paper:

**How many labelers do you have? A closer look at gold-standard labels**

The main document for the manuscript is in `./JASA-main.tex`. 

The main document for the supplementary materials is in `./JASA-supp.tex`. 
